...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, offset: Int?, sort: YelpSortMode?,radius: Int?, categories: [String]?, deals: Bool?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        ...
        if radius != nil{
            parameters["radius_filter"] = radius! as Int as AnyObject?
        }
        print(parameters)
